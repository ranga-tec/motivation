...
namespace Poms.Infrastructure.Migrations
{
    ...
    [Migration("20260313153740_EnhancedEntities")]
    partial class EnhancedEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Poms.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Poms.Domain.Entities.Fitting", b =>
                {
                    ...
                    b.Property<int>("FittingNumber")
                        .HasColumnType("int");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<DateOnly?>("NextFittingDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Poms.Domain.Entities.ProstheticEpisode", b =>
                {
                    ...
                    b.Property<string>("AmputationTypeOther")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Poms.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Poms.Domain.Entities.ApplicationUser", null)
                        .WithMany()
