        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuardianPhone1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicianId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextPlan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "OrthoticEpisodes",
                columns: table => new
                {
                    EpisodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MainProblem = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BodyRegion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Side = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrthosisTypeId = table.Column<int>(type: "int", nullable: true),
                    ReasonForProblem = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReasonOther = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrthoticEpisodes", x => x.EpisodeId);
                    table.ForeignKey(
                        name: "FK_OrthoticEpisodes_DeviceCatalogs_OrthosisTypeId",
                        column: x => x.OrthosisTypeId,
                        principalTable: "DeviceCatalogs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrthoticEpisodes_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProstheticEpisodes",
                columns: table => new
                {
                    EpisodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AmputationType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Level = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Side = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateOfAmputation = table.Column<DateOnly>(type: "date", nullable: true),
                    Reason = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReasonOther = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DesiredDeviceId = table.Column<int>(type: "int", nullable: true),
                    SelectedComponentsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProstheticEpisodes", x => x.EpisodeId);
                    table.ForeignKey(
                        name: "FK_ProstheticEpisodes_DeviceCatalogs_DesiredDeviceId",
                        column: x => x.DesiredDeviceId,
                        principalTable: "DeviceCatalogs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProstheticEpisodes_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repairs_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    EpisodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PathologicalCondition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrthoticDesign = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpinalEpisodes", x => x.EpisodeId);
                    table.ForeignKey(
                        name: "FK_SpinalEpisodes_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "WP", "Western Province" },
                    { 2, "CP", "Central Province" },
                    { 3, "SP", "Southern Province" },
                    { 4, "NP", "Northern Province" },
                    { 5, "EP", "Eastern Province" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Centers",
                columns: new[] { "Id", "Address", "Code", "DistrictId", "Name", "Phone" },
                values: new object[,]
                {
                    { 1, "Ragama", "RAG", 1, "Ragama Rehabilitation Center", "011-1234567" },
                    { 2, "Kandy", "KDY", 3, "Kandy P&O Center", "081-1234567" },
                    { 3, "Galle", "GAL", 4, "Galle Orthotic Center", "091-1234567" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NumberSeries_CenterId_Year",
                table: "NumberSeries",
                columns: new[] { "CenterId", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrthoticEpisodes_OrthosisTypeId",
                table: "OrthoticEpisodes",
                column: "OrthosisTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProstheticEpisodes_DesiredDeviceId",
                table: "ProstheticEpisodes",
                column: "DesiredDeviceId");
