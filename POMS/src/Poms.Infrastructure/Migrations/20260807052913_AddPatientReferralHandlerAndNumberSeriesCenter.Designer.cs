...
namespace Poms.Infrastructure.Migrations
{
    ...
    [Migration("20260807052913_AddPatientReferralHandlerAndNumberSeriesCenter")]
    partial class AddPatientReferralHandlerAndNumberSeriesCenter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Poms.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("AssignedClinicianName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("AssignedClinicianUserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<DateOnly?>("PreviousAppointmentDate")
                        .HasColumnType("date");

                    b.Property<TimeOnly?>("PreviousAppointmentTime")
                        .HasColumnType("time");
                    ...
                    b.HasIndex("AssignedClinicianUserId");
            ...
            modelBuilder.Entity("Poms.Domain.Entities.EmployeeProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("CanAccessRestrictedClinicalData")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Poms.Domain.Entities.Patient", b =>
                {
                    ...
                    b.Property<string>("ReferralPersonContactNumber")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");

                    b.Property<string>("ReferralPersonName")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("Poms.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithMany()
                        .HasForeignKey("AssignedClinicianUserId")
            ...
            modelBuilder.Entity("Poms.Domain.Entities.EmployeeProfile", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("Poms.Domain.Entities.EmployeeProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
